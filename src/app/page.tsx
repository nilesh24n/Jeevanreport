          ...
          {mounted && history.length > 0 ? (
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Link href="/scan" className="btn-primary min-h-[48px]">Scan new product</Link>
                <button
            ...
            <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
              <div className="space-y-7">
                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                  <Link href="/scan" id="hero-scan-btn" className="btn-primary min-h-[52px] px-8 text-base">
                    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z" />
                    </svg>
                    {t("hero.cta_scan") || "Scan barcode"}
                  </Link>
                  <Link href="/search" id="hero-search-btn" className="btn-secondary min-h-[52px] px-8 text-base">
